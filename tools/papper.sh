...
# sed -i '' "s/- \"8000:8000\"/- \"$PORT:8000\"/g" docker-compose.yml
# sed -i '' "s#- \./consume:/usr/src/paperless/consume#- $CONSUME_FOLDER:/usr/src/paperless/consume#g" docker-compose.yml
perl -pi -e "s/- \"8000:8000\"/- \"$PORT:8000\"/g" docker-compose.yml
perl -pi -e "s#- \./consume:/usr/src/paperless/consume#- $CONSUME_FOLDER:/usr/src/paperless/consume#g" docker-compose.yml
